...
combo_t key_combos[] = {
  ...
  [XC_RCBR] = COMBO(xc_combo, NO_LABK), //<
  [UY_LPRN] = COMBO(uy_combo, NO_LBRC), //[
...
#define ______________HOME_ROW_GASC_L______________ OSM(MOD_LGUI), OSM(MOD_LALT), OSM(MOD_LCTL), OSM(MOD_LSFT), TG(LAYER_NAV_L)
#define ______________HOME_ROW_GASC_R______________    U_NA, OSM(MOD_RSFT), OSM(MOD_RCTL), OSM(MOD_LALT), OSM(MOD_LGUI)
...
#define LAYOUT_LAYER_NAV                                                                      \
   ...
   KC_MNXT, KC_VOLD, KC_VOLU, KC_MPRV, KC_MNXT, KC_MNXT, KC_HOME, KC_PGDN, KC_PGUP,  KC_END, \
                    U_NA,    U_NA,    NO_LABK,                KC_MPLY, KC_MUTE, U_NA
...
#define LAYOUT_LAYER_NAV_MIRRORED                                                                      \
    ...
    KC_HOME, KC_PGDN, KC_PGUP, KC_END, KC_INS,  KC_MPRV, KC_VOLD, KC_VOLU, KC_VOLD, KC_MNXT, \
                U_NA,    KC_SPC,    U_NA,                 U_NA, U_NA, U_NA
...
#define LAYOUT_LAYER_MOUSE                                                                    \
    ...
    _______, DRGSCRL, SNIPING, KC_LSFT,     U_NA, KC_BTN2,  KC_BTN1, KC_BTN2, DRGSCRL, _______, \
                        U_NA, KC_BTN1, KC_BTN2,       KC_TRNS, KC_TRNS, U_NA
...
#define LAYOUT_LAYER_SYM                                                                      \
    ...
    CX_TILD, NO_RBRC, CX_RCBR, NO_RPRN,  CX_DLR,   KC_F5,  KC_F2, NO_RCBR, U_NA, CW_TOGG, \
                         U_NA, KC_MUTE, KC_MPLY,    U_NA, U_NA, U_NA
...
#define LAYOUT_LAYER_NUM                                                                      \
    ...
    NO_ARNG, NO_ARNG, NO_OSTR, KC_ESC,    KC_F12, CX_PIPE,    NO_1,    NO_2,    NO_3, NO_PLUS, \
                      U_NA,     U_NA,      U_NA,     NO_RABK,  NO_0, U_NA
...
#define LAYOUT_LAYER_FUN                                                                      \
    ...
    KC_LEFT, KC_DOWN, KC_UP, KC_RGHT,      DF(LAYER_BASE_QWERTY), KC_PAUS, KC_F1,   KC_F2,   KC_F3,   KC_F10, \
                         U_NA,    U_NA,    U_NA,  KC_SPC,  KC_APP, U_NA
#define LAYOUT_LAYER_MEDIA                                                                    \
    XXXXXXX,RGB_RMOD, RGB_TOG, RGB_MOD, XXXXXXX, XXXXXXX,RGB_RMOD, RGB_TOG, RGB_MOD, XXXXXXX, \
    KC_MPRV, KC_VOLD, KC_MUTE, KC_VOLU, KC_MNXT, KC_MPRV, KC_VOLD, KC_MUTE, KC_VOLU, KC_MNXT, \
    XXXXXXX, XXXXXXX, XXXXXXX, EE_CLR,  QK_BOOT, QK_BOOT, EE_CLR,  XXXXXXX, XXXXXXX, XXXXXXX, \
                      U_NA, KC_MPLY, KC_MSTP, U_NA, U_NA, U_NA
/**
 ...
 *
 * This is meant to be used with `LAYOUT_LAYER_BASE_COLEMAK_DH` defined above, eg.:
 *
 *     HOME_ROW_MOD_GASC(LAYOUT_LAYER_BASE_COLEMAK_DH)
 */
 ...
 * This is meant to be used with `LAYOUT_LAYER_BASE_COLEMAK_DH` defined above, eg.:
 *
 *     MOUSE_MOD(LAYOUT_LAYER_BASE_COLEMAK_DH)
 */
#define _MOUSE_MOD(                                               \
    L00, L01, L02, L03, L04, R05, R06, R07, R08, R09,             \
    L10, L11, L12, L13, L14, R15, R16, R17, R18, R19,             \
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [LAYER_BASE] = LAYOUT_wrapper(
    MOUSE_MOD(HOME_ROW_MOD_GASC(LAYOUT_LAYER_BASE_COLEMAK_DH))
  ),
        ...
        case CX_LCBR:
            if(record->event.pressed) {
                if (mod_shift) {
                    ...
                    tap_code16((is_apple) ? MAC_RCBR : NO_RCBR);
...
const key_override_t lprn_key_override = ko_make_basic(MOD_MASK_SHIFT, NO_LPRN, NO_RPRN);
const key_override_t rprn_key_override = ko_make_basic(MOD_MASK_SHIFT, NO_LBRC, NO_RBRC);
//const key_override_t rbrc_key_override = ko_make_basic(MOD_MASK_SHIFT, NO_LCBR, NO_RCBR);
